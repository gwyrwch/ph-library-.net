...
namespace ph.Migrations
{
    ...
    [Migration("20191017185333_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ph.Models.PetToPost", b =>
                {
                    b.Property<string>("PetId");

                    b.Property<string>("PostId");

                    b.HasKey("PetId", "PostId");

                    b.HasIndex("PostId");

                    b.ToTable("PetsPetToPosts");
                });
            ...
            modelBuilder.Entity("ph.Models.PetToPost", b =>
                {
                    b.HasOne("ph.Models.Pet", "Pet")
                        .WithMany("PetsToPosts")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade);
